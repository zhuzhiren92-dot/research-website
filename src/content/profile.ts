...
export const profile = {
  ...
  summary:
    '我研究颗粒形态、破碎和运动学如何控制颗粒材料的宏观行为。通过整合原位X射线微型CT、3D颗粒重建和追踪、机器学习和计算建模，我量化了颗粒微观结构在加载过程中的演变以及这些变化如何影响其力学响应。',
  ...
  heroMetrics: [
    { value: '6', label: ['第一作者', '期刊论文'] },
    { value: '15', label: ['期刊论文'] },
    { value: '5', label: ['资助研究', '项目'] },
    { value: '3', label: ['会议', '论文'] },
    { value: '5+', label: ['研究的粒子类型'] },
  ],
  researchWorkflow: ['成像', '重建', '追踪', '断裂', '力学'],
  links: [
    { label: 'Google Scholar', href: '#' },
    { label: 'ORCID', href: '#' },
    { label: 'GitHub', href: 'https://github.com/zhuzhiren92-dot' },
    { label: 'CV', href: `${import.meta.env.BASE_URL}CV_EN_Zhu_Zhiren.pdf` },
  ],
  focusAreas: [
